...
import { addProduct, selectProducts, setProducts } from '../Slice/productSlice';
...
const ProductList = () => {
  ...
  if (isLoading) return <div className="flex items-center justify-center h-[100vh]">
  <div role="status">
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <button
        ...
        className="bg-blue-500 text-white rounded-lg px-4 py-2 mb-2 "
        >
        Add Product
      </button>
